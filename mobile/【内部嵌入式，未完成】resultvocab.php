<div class="pages">
	...
	<div data-page="gallery" class="page toolbar-fixed navbar-fixed" data-page="tabs-animated">

		<div class="navbar">
			<div class="navbar-inner">
				<div class="left"><a href="index.html" class="back link" data-force="true"> <i class="icon icon-back"></i></a></div>
				<div class="center">photo gallery</div>
				<div class="right">
            ...
            <form class="form-horizontal templatemo-forgot-password-form templatemo-container" role="form" action="../word.php" method="post">
                ...
                <div class="form-group">
                    <div class="col-md-12">
						...
						<a href="../word.php" class="btn btn-danger">查询</a>
                        <br /><br />
